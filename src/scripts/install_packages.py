...
import glob
import subprocess
from src.utils.system import install, is_gnome, get_distro
from src.utils.utils import get_data


RESOURCES_DIR = os.path.join("src", "temp")
...
def install_debs():
    ...
    deb_dir = os.path.join(RESOURCES_DIR)  # RESOURCES_DIR é o caminho global do projeto, ex: src/resources
    os.chdir(deb_dir)
...
def intellij_install():
    ...
    install_path = os.path.join(RESOURCES_DIR, "intelliJ-install", "install.sh")
